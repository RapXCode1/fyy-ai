      ...
      <body className="min-h-screen bg-[#08080A] flex items-center justify-center p-4">
        <div className="relative w-full max-w-md p-6 rounded-2xl border border-red-500/30 bg-neutral-900/90 text-center shadow-2xl">
          ...
          <h2 className="text-2xl font-black italic tracking-tighter text-white mb-2">
            FYY-AI SAFETY SHIELD
          </h2>
          
          <p className="text-sm text-gray-300 mb-6 leading-relaxed">
            Sepertinya browser, AdBlocker, atau DNS (seperti AdGuard/Pi-hole) memblokir sistem otentikasi Clerk. Jangan khawatir, kamu tetap bisa menggunakan FYY-AI secara instan!
          </p>
