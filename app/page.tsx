...
export default function LandingPage() {
  ...
  if (isLoaded && isSignedIn) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: "#060816" }}>
  ...
  const features = [
    { icon: MessageSquare, title: "Advanced Chat", desc: "Multi-model AI chat with real-time streaming responses and rich markdown rendering.", color: "#2563FF" },
    { icon: Mic, title: "Voice I/O", desc: "Speak naturally. Get intelligent spoken responses powered by native Android TTS.", color: "#7C3AED" },
    { icon: ImageIcon, title: "Image Generation", desc: "Create stunning visuals from text prompts via HuggingFace AI models.", color: "#0891B2" },
    { icon: FileText, title: "File Analysis", desc: "Upload documents, images, and files for intelligent multimodal analysis.", color: "#059669" },
  ]

  const models = [
    { name: "FYY-Llama 3.3", sub: "PRO · Ultimate Performance", badge: "Popular", dot: "#2563FF" },
    { name: "FYY-Llama 4 Scout", sub: "Next-gen Reasoning", badge: "New", dot: "#7C3AED" },
    { name: "FYY-GPT-OSS 120B", sub: "High Performance", badge: "", dot: "#0891B2" },
    ...
    <div className="min-h-screen overflow-x-hidden" style={{ background: "#060816", color: "#F9FAFB" }}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-up">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium border"
              style={{ background: "rgba(37,99,255,0.08)", borderColor: "rgba(37,99,255,0.2)", color: "#60A5FA" }}
            >
          ...
          <div className="relative animate-fade-up delay-300 hidden lg:block">
            <div className="absolute -inset-8 rounded-3xl opacity-30"
              style={{ background: "radial-gradient(circle, rgba(37,99,255,0.15) 0%, transparent 70%)" }} />
            <div className="relative fyf-card p-0 overflow-hidden"
              style={{ background: "#0E1324", borderRadius: "22px" }}>
              {/* Window bar */}
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="flex justify-end">
                  <div className="text-sm rounded-2xl px-4 py-2.5 max-w-xs" style={{ background: "#1C2333", color: "#E5E7EB" }}>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm leading-relaxed rounded-2xl p-3"
                      ...
                      <span className="inline-block w-0.5 h-4 ml-0.5 align-middle animate-pulse-slow" style={{ background: "#2563FF" }} />
                    </div>
                  </div>
                </div>
                {/* Input mock */}
            ...
            return (
              ...
              >
                <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ background: "rgba(37,99,255,0.1)", border: "1px solid rgba(37,99,255,0.15)" }}>
      ...
      <section id="features" className="max-w-6xl mx-auto px-4 sm:px-6 py-20 border-t"
        ...
        <div className="text-center mb-14 animate-fade-up space-y-3">
          <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: "#2563FF" }}>Features</p>
      ...
      <section id="models" className="max-w-6xl mx-auto px-4 sm:px-6 py-20 border-t"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-5 animate-fade-up">
            <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: "#2563FF" }}>AI Models</p>
              ...
              >
                ...
                {m.badge && (
                  <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full"
                    style={{ background: "rgba(37,99,255,0.1)", color: "#60A5FA", border: "1px solid rgba(37,99,255,0.2)" }}>
                    {m.badge}
                  </span>
                )}
              </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-20">
        <div className="relative rounded-3xl overflow-hidden animate-fade-up"
          style={{ background: "#0E1324", border: "1px solid rgba(255,255,255,0.06)" }}>
          <div className="absolute inset-0 opacity-30"
            style={{ background: "radial-gradient(ellipse 80% 50% at 50% -20%, rgba(37,99,255,0.3), transparent)" }} />
      ...
      {/* ── FOOTER ── */}
      <footer className="border-t" style={{ borderColor: "rgba(255,255,255,0.06)", background: "#060816" }}>
